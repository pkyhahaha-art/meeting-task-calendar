...
Set `PUBLIC_APP_URL` to the deployed web-app URL. The worker uses it to generate recipient-scoped Meeting links and safe document-download links for guest Email notifications.
